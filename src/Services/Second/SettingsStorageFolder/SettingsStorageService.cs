...
namespace Cs2PracticeMode.Services.Second.SettingsStorageFolder;
...
public class SettingsStorageService : Base
{
    ...
    public SettingsStorageService(PluginConfigService pluginConfigService) : base(LoadOrder.Second)
    {
